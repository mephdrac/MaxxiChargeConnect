"""Tests für die ConsumptionEnergyTotal Entity im MaxxiChargeConnect Integration."""
...
@pytest.mark.asyncio
async def test_consumption_energy_today_init():
    """Testet die Initialisierung der ConsumptionEnergyTotal Entity."""
    ...
    assert sensor._attr_unique_id == "1234abcd_consumptionenergytotal"  # pylint: disable=protected-access
