...
class PvTodayEnergy(IntegrationSensor):
    ...
    async def async_added_to_hass(self):
        ...
        _LOGGER.debug("PvTodayEnergy: async_added_to_hass called")
        ...
        if self._unsub_time_reset is not None:
            ...
            _LOGGER.debug("PvTodayEnergy: daily reset callback registered")

    async def _reset_energy_daily(self, now):
        _LOGGER.warning("PvTodayEnergy: resetting daily energy at %s", now)
