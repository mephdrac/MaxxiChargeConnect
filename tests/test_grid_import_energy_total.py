...
@pytest.mark.asyncio
async def test_grid_export_total_init(caplog):
    ...
    sensor = GridImportEnergyTotal(hass, dummy_config_entry, source_entity)
    ...
    assert sensor._attr_unique_id == "1234abcd_gridimportenergytotal"
