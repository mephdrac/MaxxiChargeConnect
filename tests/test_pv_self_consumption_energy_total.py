"""Testet die Initialisierung und Attribute des `PvSelfConsumptionEnergyTotal` Sensors."""
...
@pytest.mark.asyncio
async def test_pv_self_consumption_energy_total_init():
    """Testet die Initialisierung der PvSelfConsumptionEnergyTotal Entity."""
    ...
    assert sensor._attr_unique_id == "1234abcd_pvselfconsumptionenergytotal"  # pylint: disable=protected-access
