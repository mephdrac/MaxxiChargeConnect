...
@pytest.mark.asyncio
async def test_battery_total_energy_discharge_init():
    """Testet die Initialisierung der BatteryTotalEnergyDischarge Entity."""
    ...
    sensor = BatteryTotalEnergyDischarge(hass, dummy_config_entry, source_entity)
    ...
    assert sensor._attr_unique_id == "1234abcd_batterytotalenergydischarge"  # pylint: disable=protected-access
